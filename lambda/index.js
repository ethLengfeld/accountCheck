...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hello! Welcome to Account Check. Would you like to check your account?';
...
const CheckAccountHandler = {
    ...
    handle(handlerInput) {
      ...
      const speakOutput = 'Welcome! Which account would you like to check?';
...
const GetAccountIntentHandler = {
    canHandle(handlerInput) {
        return (
          Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest' &&
          Alexa.getIntentName(handlerInput.requestEnvelope) === 'GetAccountIntent'
        );
    },
    handle(handlerInput) {
        //Get the slot values
        var accountType = handlerInput.requestEnvelope.request.intent.slots.accountType.value;
        
        //Share the answer
        const speakOutput = `Your ${accountType} is at $3232`;
